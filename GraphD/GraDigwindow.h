...
private slots:
    ...
    void on_actionl_l_triggered();
    void on_actionl_log_triggered();
    void on_actionlog_l_triggered();
...
private:
    ...
    // flags
    bool xflag=false; // flag to indicate whether the app is in x calibrtion mode or not
    bool yflag=false; // flag to indicate whether the app is in y calibrtion mode or not
